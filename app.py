...
MOCK_DATA = [
    ...
    },
    {
        ...
        "date": "2025-12-24 ~ 2026-01-14 매주 수",
        "ott": "Disney+",
    ...
    },
    {
        ...
        "ott": "Wavve",
        "poster": "market.jpg",
        "desc": "대지진 후 생존을 위한 거래가 시작되는 황궁마켓의 주인이 되기 위해 목숨을 건 사람들의 재난 드라마",
        "cast": "이재인, 홍경, 정만식, 유수빈, 김국희, 최정운",
        "link": "https://www.wavve.com/player/vod?programid=C9901_C99000000180&autoplay=y" 
    },
    {
        "id": 13,
        "title": "되어줄래? 나의 매니저",
        "date": "~ 2025-12-29 매주 금",
        "ott": "Wavve",
        "poster": "maneger.jpg",
        "desc": "비밀을 품고 한국의 세기예술고등학교 매니저과로 전학온 일본인 여학생 하나. 배우과 남학생 네명과 점점 가까워지는 관계속에서 감춰둔 비밀이 흔들리는 청춘 미스테리 로맨스.",
        "cast": "카논, 안준원, 윤도진, 양준범, 남민수, 한지안",
        "link": "https://www.wavve.com/player/vod?programid=C9902_C99000000047&autoplay=y" 
    },
    {
        "id": 14,
        "title": "최애와의 30분",
        "date": "2025-11-19 ~ 매주 수",
        "ott": "Wavve",
        "poster": "bais.jpg",
        "desc": "한 번 만나기도 힘든 최애와 단 30분! 예고 없이 일상에 등장한 나의 최애와 함께하는 리얼한 만남. 무슨 대화를 나누고 어떤 일이 벌어질까? 편집 없이 30분 그대로 담은 국내 최초 롱테이크 관찰 예능.",
        "cast": "신규진 외 다수",
        "link": "https://www.wavve.com/player/vod?programid=C9902_C99000000044&autoplay=y" 
    },
]
